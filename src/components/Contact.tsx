            ...
            <AnimatedSection delay={0.8} direction="right">
              <div className="bento-card p-6">
                ...
                <div className="flex gap-3">
                  <a href="https://instagram.com/ephortech" target="_blank" rel="noopener noreferrer" className="group w-11 h-11 rounded-xl bg-[var(--brand-blue)]/5 border border-[var(--brand-blue)]/15 flex items-center justify-center text-[var(--brand-blue)] hover:scale-110 hover:bg-[var(--brand-blue)]/10 hover:border-[var(--brand-blue)]/30 transition-all duration-500">
                  ...
                  <a href="https://youtube.com/@EphorTech" target="_blank" rel="noopener noreferrer" className="group w-11 h-11 rounded-xl bg-[var(--brand-blue)]/5 border border-[var(--brand-blue)]/15 flex items-center justify-center text-[var(--brand-blue)] hover:scale-110 hover:bg-[var(--brand-blue)]/10 hover:border-[var(--brand-blue)]/30 transition-all duration-500">
                  ...
                  <a href="https://linkedin.com/company/ephortech" target="_blank" rel="noopener noreferrer" className="group w-11 h-11 rounded-xl bg-[var(--brand-blue)]/5 border border-[var(--brand-blue)]/15 flex items-center justify-center text-[var(--brand-blue)] hover:scale-110 hover:bg-[var(--brand-blue)]/10 hover:border-[var(--brand-blue)]/30 transition-all duration-500">
