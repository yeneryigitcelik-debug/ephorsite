...
const services = [
  {
    ...
    description:
      "Konut ve ticari poliçe kapsamında elektronik cihaz teminatları. 81 ilde kesintisiz servis ağımızla güvenilir çözümler.",
  ...
  },
  {
    ...
    slug: "kurumlar",
    description:
      "Markaların müşterilerine özel elektronik cihaz hizmet paketleri. Kurumsal düzeyde teknik destek ve bakım.",
  ...
  },
  {
    ...
    slug: "markalar",
    description:
      "Ofis ve personel elektronik cihazlarında arıza ve hasar çözümleri. Profesyonel teknik servis hizmetleri.",
  ...
  },
  {
    ...
    description:
      "Seçkin konut projelerine özel elektronik cihaz hizmetleri. Premium hizmet paketleri.",
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        <AnimatedSection className="text-center mb-20">
          ...
          <h2 className="font-[var(--font-syne)] text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight">
            Her Sektöre{" "}
            <span className="gradient-text">Özel Çözümler</span>
          </h2>
          <p className="mt-6 max-w-2xl mx-auto text-lg text-[var(--text-secondary)] leading-relaxed">
            Farklı sektörlerin ihtiyaçlarına yönelik özelleştirilmiş teknoloji
            servis çözümlerimizle yanınızdayız.
          </p>
        </AnimatedSection>
          ...
          {services.map((service, i) => (
            <StaggerItem key={service.slug}>
              <Link
                ...
                className="group relative bento-card block overflow-hidden"
              >
                {/* Hover glow */}
                ...
                <div className="relative z-10">
                  ...
                  <div className="p-6 pt-5">
                    ...
                    <p className="text-[var(--text-secondary)] leading-relaxed text-[15px] mb-5">
                      {service.description}
                    </p>
