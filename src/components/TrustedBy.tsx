        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {partners.map((partner, i) => (
            <motion.div
              ...
              className="group relative flex flex-col items-center gap-3 p-8 rounded-2xl border border-white/[0.03] bg-white/[0.01] hover:border-[var(--brand-blue)]/10 hover:bg-white/[0.03] transition-all duration-500"
            >
              {/* Decorative circle */}
