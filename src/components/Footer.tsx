    ...
    <footer className="relative bg-[var(--bg-secondary)] border-t border-white/[0.04]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a href="https://www.instagram.com/ephortech/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-9 h-9 rounded-lg bg-white/[0.03] border border-white/[0.06] flex items-center justify-center text-[var(--text-muted)] hover:text-[var(--brand-blue)] hover:border-[var(--brand-blue)]/20 transition-all duration-300">
              ...
              <a href="https://www.youtube.com/@EphorTech" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="w-9 h-9 rounded-lg bg-white/[0.03] border border-white/[0.06] flex items-center justify-center text-[var(--text-muted)] hover:text-[var(--brand-blue)] hover:border-[var(--brand-blue)]/20 transition-all duration-300">
        ...
        <div className="mt-16 pt-8 border-t border-white/[0.04] flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-[var(--text-muted)]">&copy; {new Date().getFullYear()} EphorTech. Tüm hakları saklıdır.</p>
