...
const allPosts = [
  {
    ...
    title: "Sigorta Kapsaminda Cihaz Onarim Sureci Nasil Isler?",
    excerpt:
      "Sigorta policeniz kapsaminda cihaziniz arizalandiginda yapmaniz gereken adimlari ve surecin nasil isledigini detayli olarak anlattik.",
    category: "Sigorta",
    date: "20 Sub 2026",
    readTime: "5 dk",
    featured: true,
  },
  {
    ...
    title: "Beyaz Esyalarinizin Omrunu Uzatmanin 10 Yolu",
    excerpt:
      "Duzenli bakim ve dogru kullanim ile beyaz esyalarinizin omrunu yillar boyunca uzatabilirsiniz. Iste uzmanlarimizdan ipuclari.",
    category: "Bakim Rehberi",
    date: "15 Sub 2026",
    readTime: "4 dk",
    featured: false,
  },
  {
    ...
    title: "Kurumsal Firmalar Icin Cihaz Yonetimi Cozumleri",
    excerpt:
      "Buyuk olcekli firmalarda cihaz parkinin yonetimi, bakim planlamasi ve maliyet optimizasyonu icin profesyonel oneriler.",
    category: "Kurumsal",
    date: "8 Sub 2026",
    readTime: "6 dk",
    featured: false,
  },
  {
    ...
    title: "Garanti Sureci Hakkinda Bilmeniz Gereken Her Sey",
    excerpt:
      "EphorTech'in 1 yillik onarim garantisi kapsaminda haklariniz, surec takibi ve garanti sonrasi destek hakkinda bilgiler.",
    category: "Rehber",
    date: "1 Sub 2026",
    readTime: "3 dk",
    featured: false,
  },
  {
    ...
    title: "Konut Projelerinde Teknik Servis Hizmetlerinin Onemi",
    excerpt:
      "Yeni konut projelerinde anahtar teslim cihaz kurulumundan kampanya paketlerine kadar teknik servis hizmetlerinin rolu.",
  ...
  },
  {
    ...
    title: "7/24 Cagri Merkezi ile Musteri Deneyimini Iyilestirme",
    excerpt:
      "Profesyonel cagri merkezi desteginin musteri memnuniyetine etkisi ve EphorTech'in cagri merkezi altyapisi hakkinda.",
    category: "Hizmetler",
    date: "18 Oca 2026",
    readTime: "4 dk",
    featured: false,
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <AnimatedSection className="text-center">
              ...
              <h1 className="font-[var(--font-syne)] text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-6">
                Guncel{" "}
                <span className="gradient-text">Blog Yazilari</span>
              </h1>
              <p className="text-lg text-[var(--text-secondary)] max-w-2xl mx-auto">
                Teknik servis, sigorta surecleri ve cihaz bakimi hakkinda faydali icerikler.
              </p>
            </AnimatedSection>
          </div>
        </section>
