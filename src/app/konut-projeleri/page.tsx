      ...
      <main>
        ...
        <section className="relative min-h-[60vh] flex items-end overflow-hidden">
          <div className="absolute inset-0 z-0">
            <div className="absolute inset-0 bg-gradient-to-br from-[#3A7BAD] to-[#5B93BE] opacity-[0.06]" />
            <div className="absolute inset-0 bg-[var(--bg-primary)]/90" />
            <motion.div
              animate={{ x: [0, 30, -20, 0], y: [0, -40, 20, 0], scale: [1, 1.2, 0.9, 1] }}
              transition={{ duration: 18, repeat: Infinity, ease: "easeInOut" }}
              className="absolute top-[15%] right-[20%] w-[400px] h-[400px] rounded-full bg-gradient-to-br from-[#3A7BAD] to-[#5B93BE] opacity-[0.04] blur-[100px]"
            />
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="font-[var(--font-syne)] text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight mb-8 max-w-4xl">
                  <TextReveal>Konut Proje</TextReveal>{" "}
                  <TextReveal delay={0.2}><span className="gradient-text">Hizmetlerimiz</span></TextReveal>
                </h1>

                <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5, duration: 0.7 }} className="max-w-2xl text-xl text-[var(--text-secondary)] leading-relaxed">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7, duration: 0.6 }} className="mt-10 flex flex-wrap gap-4">
                  <Link href="/iletisim" className="group relative inline-flex items-center gap-2 px-8 py-4 text-base font-semibold text-white rounded-full overflow-hidden">
                    <span className="absolute inset-0 bg-gradient-to-r from-[#3A7BAD] to-[#5B93BE]" />
              ...
              >
                ...
                >
                  <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-[var(--brand-blue)]/10 border border-white/[0.06]">
                    <Image src="/images/konut.png" alt="Konut Projeleri" width={500} height={340} className="w-full h-auto object-cover" quality={85} />
          ...
          <div className="relative z-10 mx-auto max-w-4xl px-6 lg:px-8 text-center">
            <AnimatedSection>
              <div className="relative gradient-border p-12 md:p-16 rounded-3xl overflow-hidden">
                <div className="absolute -top-20 -right-20 w-60 h-60 bg-gradient-to-br from-[#3A7BAD] to-[#5B93BE] opacity-[0.06] rounded-full blur-3xl" />
                <div className="relative z-10">
                  ...
                  <p className="text-lg text-[var(--text-secondary)] mb-10 max-w-2xl mx-auto">Konut projelerine özel çözümlerimiz hakkında detaylı bilgi almak için hemen iletişime geçin.</p>
