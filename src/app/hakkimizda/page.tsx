          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <AnimatedSection>
              <div className="relative rounded-3xl overflow-hidden">
                <Image src="/images/slider-devices.png" alt="EphorTech Cihazlar" width={1200} height={500} className="w-full h-[300px] md:h-[400px] object-cover" quality={85} />
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                ...
                <AnimatedSection key={stat.label} delay={i * 0.12} className="text-center">
                  <span className="font-[var(--font-syne)] text-4xl md:text-5xl font-extrabold gradient-text">{stat.value}</span>
